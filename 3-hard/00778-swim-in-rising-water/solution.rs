...
impl Solution {
    pub fn swim_in_water(grid: Vec<Vec<i32>>) -> i32 {
        ...
        let directions = [(-1_i32, 0), (1, 0), (0, -1), (0,1)];
        ...
        while let Some(cell) = heap.pop() {
            ...
            let old_i_i32 = cell.i as i32;
            let old_j_i32 = cell.j as i32;

            for &(x, y) in directions.iter() {
                let new_i_i32 = old_i_i32 + x;
                let new_j_i32 = old_j_i32 + y;

                if new_i_i32 < 0 || new_i_i32 >= n_i32 || new_j_i32 < 0 || new_j_i32 >= n_i32 {
                    continue;
                }
